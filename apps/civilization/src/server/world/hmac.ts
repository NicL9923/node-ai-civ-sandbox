// Federation HMAC-SHA256 request signing. This is a faithful port of the P1
// reference canonicalization (packages/federation-contracts/test/signing.ts and
// docs/protocol.md). It MUST reproduce the golden vectors in
// packages/federation-contracts/examples/signing.vector.json exactly — see hmac.test.ts.
